...
public class Email implements Runnable {
    ...
    public void enviaMsgReservaFeita(Reserva reserva) {
        ...
        boolean naoWebConferencia = true;
        
        for(Recurso r: recursos){
            
            if (r instanceof Sala) {
                Sala sala = (Sala) r;
                if (sala.getNumero().equals("Web Conferência")) {
                    naoWebConferencia = false;
                    msgReservaFeita += "<br/><br/><br/><b><FONT COLOR=\"red\">Solicitamos que 15 minutos antes do horário agendado, "
                            + "o solicitante contate o ramal 7349 para obter acesso a sala. \n"
                            + "Segue o link da webconference:</FONT>\n"
                            + "<a href=\"http://webconf2.rnp.br/ufabc4/\">http://webconf2.rnp.br/ufabc4/</a></b>";
                }
            }
...
//        List<Recurso> recursos = reserva.getRecursos();
        ...
        if((diaSemana == 7 || diaSemana == 1 || hora < 9 || hora > 18) && naoWebConferencia){
