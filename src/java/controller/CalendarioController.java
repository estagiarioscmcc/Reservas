...
public class CalendarioController implements Serializable {
    ...
    public SalaDataModel getSalaDataModel() {
        ...
        if (salaDataModel == null) {
            ...
            if((LoginBean.getUsuario().getLogin().equals("juliana.calio")) ||
                    (LoginBean.getUsuario().getLogin().equals("josiane.metzner")) ||
                    (LoginBean.getUsuario().getLogin().equals("patricia.santos"))){
                List<Sala> salas = salaFacade.findAll();
                salaDataModel = new SalaDataModel(salas);
                
            }
            else{
                salaDataModel = new SalaDataModel(salaFacade.findAllExcept("312-2"));
            }
